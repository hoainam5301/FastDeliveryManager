...
class EditStaffDelivery extends StatefulWidget {
  //const DetailStaffDelivery({Key? key}) : super(key: key);
  final Staff staff ;
  EditStaffDelivery({this.staff});

  @override
  _EditStaffDeliveryState createState() => _EditStaffDeliveryState();
}

class _EditStaffDeliveryState extends State<EditStaffDelivery> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        EditInfo(
                          titleInfor: "Email",
                          infomation: widget.staff.email,
                          onChange: (value){
                            widget.staff.email=value;
                          },
                        ),
                        SizedBox(
                          height: 15,
                        ...
                        EditInfo(
                          titleInfor: "Gender",
                          infomation: widget.staff.gender,
                          onChange: (value){
                            widget.staff.gender=value;
                          },
                        ),
                        SizedBox(
                          height: 15,
                        ...
                        Padding(
                          ...
                          child: Align(
                              ...
                              child: TextButton(
                                child: Text(widget.staff.dateOfBirth,style: Contanst.titleInfo,),
                                onPressed: (){
                                  DatePicker.showDatePicker(context,
                                      ...
                                      onConfirm: (date) {
                                        widget.staff.dateOfBirth="${date.day}/${date.month}/${date.year}";
                                      },
                        ...
                        EditInfo(
                          ...
                          infomation: widget.staff.idAddress.noteAddress,
                          onChange: (value){
                            widget.staff.idAddress.noteAddress=value;
                          },
                        ),
                      ],
                    ),
            ...
            GestureDetector(
              onTap: (){
                //print(widget.staff.fullName);
                widget.staff.updateStaff(widget.staff.id, widget.staff).then((value) {
                  //print(value);
                  Get.off(HomePage());
                });
              },
