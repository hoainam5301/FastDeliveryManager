...
class EditWareHousing extends StatefulWidget {
  //const DetailStaffDelivery({Key? key}) : super(key: key);
  WareHousing wareHousing;
  EditWareHousing({this.wareHousing});

  @override
  _EditWareHousingState createState() => _EditWareHousingState();
}

class _EditWareHousingState extends State<EditWareHousing> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            children: [
                              EditInfo(
                                titleInfor: "Name WareHousing",
                                infomation: widget.wareHousing.name,
                                onChange: (value){
                                  widget.wareHousing.name=value;
                                },
                              ),
                              Column(
                                children: [
                                      ...
                                      child: DropdownButton<Ward>(
                                        ...
                                        onChanged: (Ward newValue) {
                                          setState(() {
                                            ...
                                            widget.wareHousing.idAddress.idWard=newValue;
                                          });
                                        },
                                        hint: Container(
                                          width: 250,
                        ...
                        EditInfo(
                          titleInfor: "FullAddress",
                          infomation: widget.wareHousing.idAddress.fullAddress,
                          onChange: (value){
                            widget.wareHousing.idAddress.fullAddress=value;
                          },
                        ),
                        EditInfo(
                          titleInfor: "Note Address",
                          infomation: widget.wareHousing.idAddress.noteAddress,
                          onChange: (value){
                            widget.wareHousing.idAddress.noteAddress=value;
                          },
                        ),
                      ],
                    ),
            ...
            GestureDetector(
              onTap: (){
                widget.wareHousing.updateWareHousing(widget.wareHousing.id, widget.wareHousing).then((value) {
                  Get.off(HomePage());
                });
              },
              child: Padding(
