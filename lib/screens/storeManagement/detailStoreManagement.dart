...
import 'package:managerdelivery/screens/storeManagement/editStoreManagement.dart';
import 'package:managerdelivery/widget/contanst.dart';
import 'package:managerdelivery/widget/showInfo.dart';

class DetailStoreDelivery extends StatelessWidget {
  //const DetailStaffDelivery({Key? key}) : super(key: key);
  final Store store;
  DetailStoreDelivery({this.store});
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            GestureDetector(
              onTap: () {
                Get.to(EditStoreDelivery(store: store,));
              },
              child: Padding(
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        ShowInfo(
                          title: "District",
                          data: store.idAddress.idWard.idDistrict.name,
                        ),
                        SizedBox(
                          height: 15,
                        ),
                        ShowInfo(
                          title: "Ward",
                          data: store.idAddress.idWard.name,
                        ),
                      ],
                    ),
                  )
